...
from fastapi.middleware.cors import CORSMiddleware  # <-- PASTIKAN BARIS INI ADA DI SINI
...
# Konfigurasi CORS agar aman terhubung ke Express.js dan Front-End (React)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],             # Mengizinkan semua domain/origin mengakses API ini
    allow_credentials=True,
    allow_methods=["*"],             # Mengizinkan semua HTTP Methods (POST, GET, OPTIONS, dll.)
